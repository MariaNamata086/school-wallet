    ...
    <main className='flex flex-col items-center tracking-wider bg-white'>
      ...
      <div className='flex z-20 flex-col gap-6 items-center justify-center'>
        <div className='w-[75%] mx-auto h-[710px] mt-10 md:mt-[100px]'>
          <Image
            src={projectMockDevices}
            style={{ objectFit: 'contain' }}
            alt='Photo showing devices for which the system is optimised'
          />
        </div>
        <Link
          href='/authentication/signup/signup-form'
          className='flex items-center justify-around p-1 rounded-full bg-darkblue w-[150px] md:w-[320px] h-[50px] md:h-[64px] -mt-[200px] mb-20'
        >
